...
WebUI.setText(findTestObject('Object Repository/Page_RevOne/input_Email_LoginInput_UserNameOrEmailAddress'), 'TestUser8')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_RevOne/input_Password_passwordInput'), '7Dxoto1EjKfQbGop/Ov+1g==')
