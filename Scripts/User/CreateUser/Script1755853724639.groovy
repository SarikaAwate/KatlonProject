...
WebUI.waitForElementClickable(findTestObject('Object Repository/NewUser/Page_RevOne/span_User Access Logs_lpx-menu-item-text hi_e1ede2'), 10)
WebUI.click(findTestObject('Object Repository/NewUser/Page_RevOne/span_User Access Logs_lpx-menu-item-text hi_e1ede2'))

WebUI.waitForElementClickable(findTestObject('Object Repository/NewUser/Page_RevOne/span_Administration_lpx-menu-item-text hidd_7477db'), 10)
WebUI.click(findTestObject('Object Repository/NewUser/Page_RevOne/span_Administration_lpx-menu-item-text hidd_7477db'))

WebUI.waitForElementClickable(findTestObject('Object Repository/NewUser/Page_RevOne/span_Roles_lpx-menu-item-text hidden-in-hov_47be33'), 10)
WebUI.click(findTestObject('Object Repository/NewUser/Page_RevOne/span_Roles_lpx-menu-item-text hidden-in-hov_47be33'))

WebUI.waitForElementClickable(findTestObject('Object Repository/NewUser/Page_Users  RevOne/button_Users_d-inline-flex align-items-cent_5fc07c'), 10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/NewUser/Page_Users  RevOne/div_Roles_ngb-nav-0-panel'), 10)
...
WebUI.setText(findTestObject('Object Repository/NewUser/Page_Users  RevOne/input_Email address_email'), 'Test@gmail.com')

WebUI.waitForElementVisible(findTestObject('Object Repository/NewUser/Page_Users  RevOne/input_Phone number_phone-number'), 10)
WebUI.setText(findTestObject('Object Repository/NewUser/Page_Users  RevOne/input_Phone number_phone-number'), '8989898989')

WebUI.waitForElementClickable(findTestObject('Object Repository/NewUser/Page_Users  RevOne/a_User Information_ngb-nav-1'), 10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/NewUser/Page_Users  RevOne/label_Roles_form-check-label ng-star-inserted'), 10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/NewUser/Page_Users  RevOne/form_New user_ng-star-inserted ng-dirty ng-_d1524f'), 10)
...
WebUI.waitForElementClickable(findTestObject('Object Repository/NewUser/Page_Users  RevOne/div_Delete_ng-star-inserted'), 10)
